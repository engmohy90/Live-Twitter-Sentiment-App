...
app.layout = html.Div(
    [
        ...
        dbc.NavbarSimple(
            children=[
                dbc.NavLink(" وزارة أبشر", href="/page-1", id="page-1-link"),
                dbc.NavLink("وزارة الصحه", href="/page-2", id="page-2-link"),
                dbc.NavLink("وزارة الاسكان", href="/page-3", id="page-3-link"),
                dbc.NavLink("وزارة التعليم", href="/page-4", id="page-4-link"),
            ],
